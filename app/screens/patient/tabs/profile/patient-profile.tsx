...
export const LatestVitalsItems = ({ info, onPress, }: { info: any, onPress: (info: any) => void }) => {
        return (
            <TouchableOpacity
                ...
                style={{ flex: 1}}>
                    <View style={ItemMainView}>
                        ...
                        <View style={{flex:0.1, justifyContent: 'center', alignItems: 'flex-end', marginTop: -40}}>
...
export const EmergencyContactsItems = ({ info, onPress,}: { info: any, onPress: (info: any) => void }) => {
        return (
            <TouchableOpacity
                onPress={() => onPress(info)}>
                    <View style={ItemMainView}>
    ...
    <View style={FULL}>
      <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
        <View style={OUTER_SHADOW_VIEW}>
                ...
                <FlatList
                        data={basicInfo}
                        renderItem={({ item }) => <BasicInfoItems info={item} onPress={() => {}} isBasicInfo={true} />}
        ...
        <View style={OUTER_SHADOW_VIEW}>
                ...
                <FlatList
                        ...
                        renderItem={({ item }) => <EmergencyContactsItems info={item} onPress={() => {}} isBasicInfo={false} />}
                        keyExtractor={(item, index) => index.toString()}
                    />
        </View>
      </Screen>
