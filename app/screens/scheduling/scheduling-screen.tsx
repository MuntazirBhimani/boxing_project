...
import { SchedulingUpcoming } from "./tabs/upcoming/scheduling-upcoming"
import { SchedulingCompleted } from "./tabs/completed/scheduling-completed"
...
export default function SchedulingScreen() {
  ...
  const renderScene = SceneMap({
    upcoming: SchedulingUpcoming,
    completed: SchedulingCompleted
  })
      ...
      renderLabel={({ route, focused }) => (
        <Text
          style={[
            ...
            { textAlign: "center", fontSize: 14, fontFamily: typography.latoSemiBold, lineHeight: 22 },
          ]}
          text={route.title}
        />
      )}
  ...
  return (
    <View style={styles.scene}>
        <View style={styles.headerView}>
          ...
          <Text text={"Scheduling"} style={styles.headerText} />
        </View>
        <TabView
